class BattleAnnouncer {
  ...
  announceMove(pokemon, move) {
    //maybe display immediately without needing to cycle through
  ...
  announceStartOfBattle() {
    //perhaps display this immediately
  ...
  announceActionPrompt() {
    //can probably just put this on the side regardless
  ...
  announceMovePrompt(pokemon) {
    //can also put this on the side regardless
